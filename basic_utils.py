...
class myTokenizer():
    ...
    def __init__(self, args):
        if args.vocab == 'bert':
            tokenizer = AutoTokenizer.from_pretrained('./../wiki_art_paintings/models/vit/custom-xlmroberta-tokenizer-60k')
...
def load_model_emb(args, tokenizer):
    ...
    path_save = '{}/VAE_model.pt'.format('vae-checkpoint')
    #path_save = '{}/random_emb.torch'.format('vae-checkpoint')
